...
public class MostEnergeticMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (identifier.contains("analysis")) {
            ...
            // Extracting loudness
            String dancability = parts[Constants.Analysis.DANCEABILITY_INDEX];
            String energy = parts[Constants.Analysis.ENERGY_INDEX];
            outputValue = "ANALYSIS_" + dancability + "|" + energy;
        } else {
